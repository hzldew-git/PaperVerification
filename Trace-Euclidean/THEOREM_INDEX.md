...
| Regularized Dedekind zeta zeros | V15DedekindZetaRegularization.exists_nonzero, value_unique, zeroSet_discrete, finite_zeros_in_compact; V15DedekindZetaZeroOccurrence.fibre_card, boundedSet_finite, corollary12_of_numeric, and paired_sum_summable_of_field_HSW | FORMALIZED_COMPONENT conditional on an entire regularization; finite-height occurrence sets and their multiplicities are proved; existence of the regularization, conjugation symmetry, the numerical HSW theorem, and an ordered enumeration remain EXTERNAL_INPUTS |
