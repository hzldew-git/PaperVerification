...
| Odlyzko unconditional kernel and prime correction | v15OdlyzkoHCore_nonneg, v15OdlyzkoH_eq_autocorrelation, v15OdlyzkoH_fourier_eq_square, v15OdlyzkoSechFourier, v15OdlyzkoF4_fourier_eq_convolution, v15OdlyzkoF4_fourier_re_nonneg, v15OdlyzkoF4_fourier_im_eq_zero, v15OdlyzkoPrimeCorrection_eq_finite, v15OdlyzkoPrimeCorrection_nonneg, and v15_odlyzkoTable4DescriptionInput_of_explicitCorrection | FORMALIZED_COMPONENT; `H` is an autocorrelation, the hyperbolic-secant transform is evaluated exactly, the complete `F` transform is real and nonnegative, and the complete prime sum is reduced to norms at most 4095 and exponents at most eleven; the completed explicit formula and archimedean constants remain EXTERNAL_INPUTS |
