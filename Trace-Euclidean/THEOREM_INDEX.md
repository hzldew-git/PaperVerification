...
| Odlyzko unconditional kernel and prime correction | v15OdlyzkoHCore_nonneg, v15OdlyzkoH_eq_autocorrelation, v15OdlyzkoH_fourier_eq_square, v15OdlyzkoSechFourier, v15OdlyzkoF4_fourier_eq_convolution, v15OdlyzkoF4_fourier_re_nonneg, v15OdlyzkoF4_source_test_hypotheses, v15OdlyzkoF4_archimedean_error_integral, v15OdlyzkoPhi_one_sub, v15OdlyzkoPhi_zero_add_one, v15OdlyzkoSinhIntegrand_integrableOn, V15OdlyzkoNumerical.abIntegralCertificate, v15OdlyzkoPrimeCorrection_eq_finite, v15OdlyzkoPrimeCorrection_nonneg, v15_odlyzkoTable4ExplicitCorrectionInput_of_sourceFormula, and v15_odlyzkoTable4DescriptionInput_of_explicitCorrection | FORMALIZED_COMPONENT; `H` is an autocorrelation, the complete `F` transform is real and nonnegative, source differentiability and derivative decay are proved, `Phi(0)=Phi(1)=16/3`, the exact error integral is `E=32/3`, both archimedean integrals converge, and strict `A,B` bounds follow from dyadic certificates with disclosed native-compiler trust; the complete prime sum is finite; the source formula and strict-integral certificate imply Table 4 conditionally; the explicit formula and actual zero occurrence count remain EXTERNAL_INPUTS |
| Odlyzko fourth-power decay and paired zero summability | v15OdlyzkoH_contDiff_four, v15OdlyzkoTiltedF4_exists_uniform_fourth_mass, v15OdlyzkoPhi_exists_fourthPowerBound, v15OdlyzkoPhi_conj_pair_summable_of_ordinalBound, and v15_odlyzkoTable4ExplicitCorrectionInput_of_count | FORMALIZED_COMPONENT; exact `C^4` gluing, uniform mass bounds, and Fourier decay are proved; an ordered actual-zero enumeration and its quadratic count remain EXTERNAL_INPUTS |
| Regularized Dedekind zeta zeros | V15DedekindZetaRegularization.exists_nonzero, value_unique, zeroSet_discrete, finite_zeros_in_compact, conj_symm, order_conj; V15DedekindZetaZeroOccurrence.fibre_card, boundedSet_finite, conjugateEquiv, conjugate_mem_boundedSet_iff, corollary12_of_numeric, and paired_sum_summable_of_field_HSW_auto | FORMALIZED_COMPONENT conditional on an entire regularization; finite-height occurrence sets, multiplicity, conjugation symmetry, and multiplicity-preserving conjugation are proved; existence of the regularization, the numerical HSW theorem, and an ordered enumeration remain EXTERNAL_INPUTS |
