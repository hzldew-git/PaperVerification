...
formula and convergence of its paired zero sum, the test function's
differentiability condition, and the certified archimedean estimates for A
and B remain external mathematics.
