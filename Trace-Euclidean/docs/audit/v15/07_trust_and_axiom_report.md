...
The Lean project has a successful complete build on Lean 4.32.1 with the pinned mathlib revision. The checked v15 endpoint axiom sets contain only propext, Classical.choice, and Quot.sound. Source scanning found no sorry, sorryAx, project axiom, native_decide, run_tac, unsafe, extern, or implemented_by in the proof source.
