# Existing v9 formalization and v15 reuse assessment

This inventory describes the copied public v9 Lean project before v15-specific
...
| V15 finite grid and exact table results | The v9 Mathematica package uses removed analytic labels and the old finite grid | New v15 source binding and tests are required; v9 result files cannot be relabeled. |
