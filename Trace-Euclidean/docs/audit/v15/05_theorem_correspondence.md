...
| Proposition 6.1 | v15_proposition_six_one_full: actual nonzero fractional ideal, totally positive integral coefficient, reduced Gram basis, determinant, exact radius, and both positive-integer scalar formulas on the full integer ring. GlobalLatticePresentation.rankOne_ideal_bridge_degree supplies the canonical abstract presentation at the manuscript threshold. | PROVISIONAL_MATCH; independent semantic sign-off pending. |
