...
- Formal project: PaperVerification/Trace-Euclidean/lean; the current source includes the general-radius, rank-one ideal, and Proposition 6.1 bridge modules. The earlier v15 baseline was code commit f3f8649c5f0e3820b8bbdc5216f44eb6d3df8edf.
- Proof assistant: Lean 4.32.1 with mathlib revision 520045ab14e26149ee970e2e617ca04b09bde5d6.
- Main results reviewed: Theorems 1.2, 1.3, and 1.7, plus Corollary 1.9. Corollary 1.6, all clauses of Proposition 6.1, the abstract-space coordinate transport over coded fields, and the rank-one ideal presentation now have additional formal endpoints, pending independent semantic review.
