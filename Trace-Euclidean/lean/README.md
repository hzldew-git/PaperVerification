...
| V15OdlyzkoFourthRegularity, V15OdlyzkoFourthDecayCriterion | Exact `C^4` gluing at `0` and both support endpoints, fourth derivative formula, uniform closed-strip mass bounds, `Phi` fourth-power decay, and paired-zero summability conditional on a quadratic zero count |
