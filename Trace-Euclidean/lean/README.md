...
| V15OdlyzkoKernel, V15OdlyzkoAutocorrelation, V15OdlyzkoFourier, V15OdlyzkoSechFourier, V15OdlyzkoFinalFourier, V15OdlyzkoTiltedSech, V15OdlyzkoZeroStrip, V15OdlyzkoDifferentiability, V15OdlyzkoArchimedean, V15OdlyzkoPrimeCorrection, V15OdlyzkoAnalyticBridge | Source-exact unconditional `b = 4` kernel; autocorrelation and Fourier positivity; source-normalized zero-transform positivity throughout the closed critical strip; global differentiability and derivative decay of `F`; exact `E = 32/3` integral; complete prime-ideal correction and its Table 4 bridge |
