...
Local adaptation: retained the generic section through `logDeriv_partial_fraction_disk`,
redirected imports, and moved declarations into `TraceEuclidean.Analytic`.
-/
/-
Zeta23/WeilEF/Landau.lean

Landau's lemma (Borel–Carathéodory + Jensen route; Mathlib: Analysis/Complex/BorelCaratheodory,
JensenFormula): zero counts and the partial-fraction expansion of f'/f on disks.
This local adaptation retains only the generic unit-disk and rescaled-disk results.
-/
import TraceEuclidean.Analytic.LandauCore
